...
- (void)showToast:(UIView *)toast duration:(CGFloat)interval position:(id)point {
    ...
    CGRect frameToast = toast.frame;
    frameToast.origin.y = frameToast.origin.y - 10;
    [toast setFrame:frameToast];
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        CGSize expectedSizeTitle = LABEL_SIZE(title, maxSizeTitle.width, maxSizeTitle.height, CSToastFontSize);
    ...
    if (message != nil) {
        ...
        CGSize expectedSizeMessage = LABEL_SIZE(message, maxSizeMessage.width, maxSizeMessage.height, CSToastFontSize);
